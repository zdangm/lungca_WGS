######################################################
# Gene-centric analysis for noncoding rare variants 
# in long masks of protein-coding genes
######################################################
rm(list=ls())
gc()
...
## output path
output_path <- "./Output_Association/Lung_Cancer/Gene_Centric_NonCoding/"
## output file name
output_file_name <- "Freeze_1_LuC_Noncoding"
